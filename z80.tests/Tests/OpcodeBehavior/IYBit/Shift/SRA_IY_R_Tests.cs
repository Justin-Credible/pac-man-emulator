...
{
    public class SRA_IY_R_Tests : BaseTest
    {
        ...
        public void Test_SRA_IY_R(Register register, int offset, byte initialValue, byte expectedValue, ConditionFlags expectedFlags)
        {
