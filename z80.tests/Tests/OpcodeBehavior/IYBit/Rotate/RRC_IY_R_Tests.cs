...
{
    public class RRC_IY_R_Tests : BaseTest
    {
        ...
        public void Test_RRC_IY_R_SetsCarryFlagTrue(Register register, int offset)
        {
        ...
        [Theory]
        [MemberData(nameof(GetDataForRegisters))]
        public void Test_RRC_IY_R_SetsCarryFlagFalse(Register register, int offset)
        {
            var rom = AssembleSource($@"
                org 00h
                RRC (IY {(offset < 0 ? '-' : '+')} {Math.Abs(offset)}), {register}
        ...
        [InlineData(-33)]
        [InlineData(-62)]
        public void Test_RRC_IY_SetsCarryFlagTrue(int offset)
        {
            var rom = AssembleSource($@"
                org 00h
        ...
        [InlineData(-33)]
        [InlineData(-62)]
        public void Test_RRC_IY_SetsCarryFlagFalse(int offset)
        {
            var rom = AssembleSource($@"
                org 00h
                RRC (IY {(offset < 0 ? '-' : '+')} {Math.Abs(offset)})
