...
{
    public class SLA_IX_R_Tests : BaseTest
    {
        ...
        public void Test_SLA_IX_R(Register register, int offset, byte initialValue, byte expectedValue, ConditionFlags expectedFlags)
        {
        ...
        public void Test_SLA_IX(int offset, byte initialValue, byte expectedValue, ConditionFlags expectedFlags)
        {
            var rom = AssembleSource($@"
                org 00h
