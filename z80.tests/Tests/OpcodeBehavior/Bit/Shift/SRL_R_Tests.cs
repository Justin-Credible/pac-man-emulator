...
namespace JustinCredible.ZilogZ80.Tests
{
    public class SRL_R_Tests : BaseTest
    {
        public static IEnumerable<object[]> GetDataForRegisters()
        {
            ...
            {
                list.Add(new object[] { register, 0b11001001, 0b01100100, new ConditionFlags() { Carry = true, Zero = false, Sign = false, ParityOverflow = false } });
                list.Add(new object[] { register, 0b11100100, 0b01110010, new ConditionFlags() { Carry = false, Zero = false, Sign = false, ParityOverflow = true } });
                list.Add(new object[] { register, 0b00000001, 0b00000000, new ConditionFlags() { Carry = true, Zero = true, Sign = false, ParityOverflow = true } });
        ...
        public static IEnumerable<object[]> GetDataForHLRegister()
        {
            ...
            list.Add(new object[] { 0b11001001, 0b01100100, new ConditionFlags() { Carry = true, Zero = false, Sign = false, ParityOverflow = false } });
            list.Add(new object[] { 0b11100100, 0b01110010, new ConditionFlags() { Carry = false, Zero = false, Sign = false, ParityOverflow = true } });
            list.Add(new object[] { 0b00000001, 0b00000000, new ConditionFlags() { Carry = true, Zero = true, Sign = false, ParityOverflow = true } });
