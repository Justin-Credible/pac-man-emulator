...
namespace JustinCredible.ZilogZ80.Tests
{
    public class CPIR_Tests : BaseTest
    {
        ...
        public void Test_CPIR(byte initialAValue, byte[] initialMemValues, UInt16 initialBCValue, UInt16 initialHLValue, int expectedCyles, int expectedIterations, ConditionFlags expectedFlags)
        {
            ...
            // Register pairs BC should be decremented and HL should be incremented.
