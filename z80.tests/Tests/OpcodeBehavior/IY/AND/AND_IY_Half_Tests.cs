...
{
    public class AND_IY_Half_Tests : BaseTest
    {
        ...
        public void Test_AND_IY_Half(bool high, byte initialValue, UInt16 valueToAND, byte expectedValue, ConditionFlags expectedFlags)
        {
