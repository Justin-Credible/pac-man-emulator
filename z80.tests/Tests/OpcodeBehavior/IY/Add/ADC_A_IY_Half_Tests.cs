...
{
    public class ADC_A_IY_Half_Tests : BaseTest
    {
        ...
        public void Test_ADC_A_IY_Half(bool high, byte initialValue, UInt16 valueToAdd, byte expectedValue, bool initialCarryFlag, ConditionFlags expectedFlags)
        {
