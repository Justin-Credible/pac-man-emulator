...
{
    public class OR_IY_Half_Tests : BaseTest
    {
        ...
        public void Test_OR_IY_Half(bool high, byte initialValue, UInt16 valueToOR, byte expectedValue, ConditionFlags expectedFlags)
        {
