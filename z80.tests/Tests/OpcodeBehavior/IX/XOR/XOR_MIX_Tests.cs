...
{
    public class XOR_MIX_Tests : BaseTest
    {
        ...
        public void Test_XOR_MIX(int offset, byte initialValue, byte valueToXOR, byte expectedValue, ConditionFlags expectedFlags)
        {
