...
{
    public class SBC_IX_Tests : BaseTest
    {
        ...
        public void Test_SBC_IX(int offset, byte initialValue, byte valueToAdd, byte expectedValue, bool initialCarryFlag, ConditionFlags expectedFlags)
        {
